export const dashboardData = {
  ...
  metrics: {
    ...
    monthlySpending: "$2,160.00",
    growth: "+12% from last month",
    spendChange: "-6% from last month",
    activeProjects: 3,
    successRate: "98%",
  },
  activeProjects: [
  ...
  notifications: [
    {
      ...
      detail: "FinTech Solutions asked for review on Auth Layer deliverable.",
      time: "4m ago",
      level: "info",
      to: "/my-jobs",
      cta: "Open Milestone",
    },
    {
      ...
      detail: "A completed contract is ready for withdrawal.",
      time: "1h ago",
      level: "success",
    ...
    },
    {
      ...
      detail: "Shopify Store Optimization has a pending clarification.",
      time: "3h ago",
      level: "warning",
      to: "/inbox",
      cta: "Reply in Inbox",
